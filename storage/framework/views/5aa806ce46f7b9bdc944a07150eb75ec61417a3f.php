...
<?php $__env->startSection('content'); ?>
                            ...
                            <table class="table custom-table text-center ">
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-weight-500"><?php echo e($currency); ?><?php echo e($user->sales()); ?></span>
                                        </td>
                                        <td class="text-dark-blue font-weight-500 align-middle"><?php echo e(dateTimeFormat($user->created_at,'Y M j | H:i')); ?></td>
    ...
    <div class="my-30">
        <?php echo e($users->links('vendor.pagination.panel')); ?>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u755557192/domains/nextnow.in/public_html/resources/views/web/default/panel/manage/instructors.blade.php ENDPATH**/ ?>