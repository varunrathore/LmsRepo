<div id="bulkDescriptiveQuestionModal" class="<?php echo e(empty($question_edit) ? 'd-none' : ''); ?>">
        ...
        <form action="/admin/quizzes-questions/<?php echo e(empty($question_edit) ? 'store' : $question_edit->id.'/update'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-md-8">
                    <div class="form-group">
                        <label class="input-label"><?php echo e(trans('quiz.bulk_add_descriptive')); ?></label>
...
<?php /**PATH C:\xampp\htdocs\lms\resources\views/admin/quizzes/modals/bulk_descrptive_question.blade.php ENDPATH**/ ?>