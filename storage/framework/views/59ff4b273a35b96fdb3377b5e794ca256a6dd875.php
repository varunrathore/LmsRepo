    ...
    <div class="mt-15">
        <?php if(!empty($instructor->meeting) and !$instructor->meeting->disabled and !empty($instructor->meeting->amount)): ?>
            <?php if(!empty($instructor->meeting->discount)): ?>
                <span class="font-20 text-primary font-weight-bold"><?php echo e($currency); ?><?php echo e(($instructor->meeting->amount - (($instructor->meeting->amount * $instructor->meeting->discount) / 100))); ?></span>
                <span class="font-14 text-gray text-decoration-line-through ml-10"><?php echo e($currency); ?><?php echo e($instructor->meeting->amount); ?></span>
            <?php else: ?>
                <span class="font-20 text-primary font-weight-500"><?php echo e($currency); ?><?php echo e($instructor->meeting->amount); ?></span>
            <?php endif; ?>
        <?php endif; ?>
    </div>
...
<?php /**PATH /home/u755557192/domains/nextnow.in/public_html/resources/views/web/default/pages/instructor_card.blade.php ENDPATH**/ ?>