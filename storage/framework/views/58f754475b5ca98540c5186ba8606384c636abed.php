                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][start_date]" class="js-ajax-start_date form-control datepicker" value="<?php echo e(!empty($ticket) ? dateTimeFormat($ticket->start_date, 'Y-m-d') :''); ?>" aria-describedby="dateRangeLabel"/>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6 mt-15 mt-lg-0">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="ajax[<?php echo e(!empty($ticket) ? $ticket->id : 'new'); ?>][end_date]" class="js-ajax-end_date form-control datepicker" value="<?php echo e(!empty($ticket) ? dateTimeFormat($ticket->end_date, 'Y-m-d') :''); ?>" aria-describedby="dateRangeLabel"/>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /home/u755557192/domains/nextnow.in/public_html/resources/views/web/default/panel/webinar/create_includes/accordions/ticket.blade.php ENDPATH**/ ?>