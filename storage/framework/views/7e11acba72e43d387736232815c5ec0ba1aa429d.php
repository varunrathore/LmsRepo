    ...
    <div class="col-12 col-md-6 mt-15">
        ...
        <?php if($webinar->isWebinar()): ?>
            <div class="form-group mt-15">
                ...
                <input type="text" name="capacity" value="<?php echo e((!empty($webinar) and !empty($webinar->capacity)) ? $webinar->capacity : old('capacity')); ?>" class="form-control <?php $__errorArgs = ['capacity'];
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u755557192/domains/nextnow.in/public_html/resources/views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>