(function ($) {
    ...
    $('body').on('click', '#add_multiple_questions', function (e) {
        e.preventDefault();
        const quiz_id = $(this).attr('data-quiz-id');

        var multipleQuestionModal = $('.bulkMultipleQuestionModal' + quiz_id);
        var clone = multipleQuestionModal.clone();
        var id = 'correctAnswerSwitch' + randomString();
        clone.find('label.js-switch').attr('for', id);
        clone.find('input.js-switch').attr('id', id);
    ...
    $('body').on('click', '#add_descriptive_questions', function (e) {
        e.preventDefault();
        const quiz_id = $(this).attr('data-quiz-id');

        var multipleQuestionModal = $('.bulkDescriptiveQuestionModal' + quiz_id);
        var clone = multipleQuestionModal.clone();
        var id = 'correctAnswerSwitch' + randomString();
        clone.find('label.js-switch').attr('for', id);
        clone.find('input.js-switch').attr('id', id);
