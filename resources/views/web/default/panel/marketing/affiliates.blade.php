            ...
            <div class="row">
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $currency }}{{ round($registrationBonus, 2) }}</strong>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $currency }}{{ round($affiliateBonus, 2) }}</strong>
    ...
    <section class="mt-25">
        ...
        @if(!empty($referralSettings))
            <div class="mt-15 font-14 text-gray">
                @if(!empty($referralSettings['affiliate_user_amount']))<p>- {{ trans('panel.user_registration_reward') }}: {{ $currency }}{{ $referralSettings['affiliate_user_amount'] }}</p>@endif
                @if(!empty($referralSettings['referred_user_amount']))<p>- {{ trans('panel.referred_user_registration_reward') }}: {{ $currency }}{{ $referralSettings['referred_user_amount'] }}</p>@endif
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <div class="row">
                <div class="col-12 ">
                        ...
                        <table class="table text-center custom-table">
                            ...
                            @foreach($affiliates as $affiliate)
                                <tr>
                                    ...
                                    <td>{{ $currency.$affiliate->getAffiliateRegistrationAmountsOfEachReferral() }}</td>

                                    <td>{{ $currency.$affiliate->getTotalAffiliateCommissionOfEachReferral() }}</td>
                    ...
                    <div class="my-30">
                        {{ $affiliates->links('vendor.pagination.panel') }}
                    </div>
                </div>
            </div>
        </div>
