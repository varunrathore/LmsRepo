            ...
            <section class="mt-30">
                <div class="d-block d-md-flex justify-content-between align-items-center pb-20">
                    ...
                    <div class="d-flex align-items-center mt-20 mt-md-0">
                        ...
                        <button id="add_multiple_questions" data-quiz-id="{{ $quiz->id }}" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10">{{ trans('quiz.add_bulk_multiple_choice') }}</button>
                        <button id="add_descriptive_questions" data-quiz-id="{{ $quiz->id }}" type="button" class="quiz-form-btn btn btn-primary btn-sm ml-10">{{ trans('quiz.bulk_add_descriptive') }}</button>
                    </div>
                </div>
...
@if(!empty($quiz))
    ...
    @include(getTemplate() .'.panel.quizzes.modals.bulk_multiple_question',['quiz' => $quiz])
    @include(getTemplate() .'.panel.quizzes.modals.bulk_descrptive_question',['quiz' => $quiz])
@endif
