<div id="bulkDescriptiveQuestionModal" class="@if(!empty($quiz)) bulkDescriptiveQuestionModal{{ $quiz->id }} @endif {{ empty($question_edit) ? 'd-none' : ''}}">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('quiz.bulk_add_descriptive') }}</h2>
