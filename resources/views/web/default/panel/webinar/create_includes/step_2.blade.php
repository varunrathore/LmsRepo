    ...
    <div class="col-12 col-md-6 mt-15">
        ...
        @if($webinar->isWebinar())
            <div class="form-group mt-15">
                ...
                <input type="text" name="capacity" value="{{ (!empty($webinar) and !empty($webinar->capacity)) ? $webinar->capacity : old('capacity') }}" class="form-control @error('capacity')  is-invalid @enderror" placeholder="{{ trans('forms.capacity_placeholder') }}"/>
                @error('capacity')
