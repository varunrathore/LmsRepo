...
<div id="bulkMultipleQuestionModal" class="{{ empty($question_edit) ? 'd-none' : ''}}">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('quiz.multiple_choice_question') }}</h2>
        ...
        <form action="/admin/quizzes-questions/{{ empty($question_edit) ? 'store' : $question_edit->id.'/update' }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mt-3">
                ...
                <div class="col-12 col-md-8">
                    <div class="form-group">
                        <label class="input-label">{{ trans('quiz.add_bulk_multiple_choice') }}</label>
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                <button type="submit" class="save-question-bulk btn btn-sm btn-primary">{{ trans('public.save') }}</button>
